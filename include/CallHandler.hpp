...
/**
 * The CallHandler class handles an instance of arguments and executes the recorded instructions on the arguments.
 * The instance of argument matchers has to be provided to the constructor of the class.
 *
...
/**
 * Specialized implementation of CallHandler class when the return type is 'void'.
 * This is mandatory to avoid compilation errors because of void arguments (in the function thenReturn).
 *
 * In this implementation, the method thenReturn creates a lambda function which does nothing and forwards it to the
 * method then.
 */
...
/**
 * Implementation of the CallHandler when the return type is anything but void (this implementation would fail with
 * void return type because of the function which would take void as a named argument).
 *
 * In this implementation, the method thenReturn creates a lambda function returning the valueToReturn and forwards it
 * to the method then.
 */
template<typename ReturnType, typename ... ArgumentTypes>
...
public:
    ...
    /**
     * Instantiates the CallHandler object to return the provided argument when called.
     *
    ...
    {
        // [=] means that the local variable must be captured in the lambda function
